		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><strong>Thêm mới tour</strong></li>
				</ol>
			</div>
		</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="google">
										...
										<div class="g-link"><?php echo ($this->input->post('canonical')) ? site_url($this->input->post('canonical')) : 'https://sunvboy.xyz/kho-giao-dien-website.html'; ?></div>
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<div class="form-row">
											<?php echo form_dropdown('catalogue[]', '', (isset($catalogue)?$catalogue:NULL), 'class="form-control " multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm.."  style="width: 100%;" id="tour_catalogue"'); ?>
										</div>
									</div>
								</div>
							</div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <div class="attr-more-info">
                                            ...
                                            <?php $content_info  = $this->input->post('content_info') ;
                                            if (isset($content_info) && is_array($content_info) && count($content_info)){ ?>
                                                <?php foreach($content_info['title'] as $key => $val){ ?>
                                                    <div class="form-group desc-more-info">
                                                        <div class="col-lg-12">
                                                            <input type="text" name="content_info[title][]" value="<?php echo $content_info['title'][$key]; ?>" class="form-control" placeholder="Tiêu đề">
