		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><strong>Tạo mới tour</strong></li>
				</ol>
			</div>
		</div>
		...
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="row">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-6 m-b">
									...
									<div class="form-row">
										<?php echo form_input('price', set_value('price',number_format($tour['price'],'0',',','.') ,0), 'class=" m-b-sm form-control int" placeholder="đ" autocomplete="off"');?>
										<div class="uk-flex uk-flex-middle">
											<div class="m-r-sm">
								...
								<div class="col-lg-6 m-b">
									...
									<div class="form-row">
										<?php echo form_input('price_sale', set_value('price_sale', addCommas($tour['price_sale']),0), 'class="form-control int" placeholder="đ" autocomplete="off"');?>
									</div>
								</div>
							</div>
									...
									<div class="col-lg-12">
										<div class="form-row">
											<div class="uk-flex uk-flex-middle uk-flex-space-between">
												...
												<span style="color:#9fafba;"><span id="titleCount"><?php echo strlen($tour['meta_title']) ?></span> trên 70 ký tự</span>
											</div>
									...
									<div class="col-lg-12">
										<div class="form-row">
											<div class="uk-flex uk-flex-middle uk-flex-space-between">
												...
												<span style="color:#9fafba;"><span id="descriptionCount"><?php echo strlen($tour['meta_description']) ?></span> trên 320 ký tự</span>
											</div>
				...
				<div class="col-lg-4">
								...
								<div class="col-lg-12">
									<div class="form-row">
										...
										<div class="block clearfix">
											<div class="i-checks mr30" style="width:100%;"><span style="color:#000;"> <input <?php echo ($this->input->post('publish') == 0) ? 'checked' : (($tour['publish'] == 0) ? 'checked' : '') ?>  class="popup_gender_1 gender" type="radio" value="0"  name="publish"> <i></i>Cho phép hiển thị trên website</span></div>
										</div>
										<div class="block clearfix">
											<div class="i-checks" style="width:100%;"><span style="color:#000;"> <input type="radio" <?php echo ($this->input->post('publish') == 1) ? 'checked' : (($tour['publish'] == 1) ? 'checked' : '') ?>  class="popup_gender_0 gender" required value="1" name="publish"> <i></i> Tắt chức năng hiển thị trên website. </span></div>
										</div>
									</div>
									<?php 
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<div class="form-row">
											<select name="catalogue[]" data-json="<?php echo base64_encode($tour['catalogue']) ?>" data-condition="" class="form-control selectMultipe" multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm.." data-module="tour_catalogue"  style="width: 100%;">
											</select>
                    ...
                    <div class="ibox mb20">
                        <div class="ibox-title uk-flex uk-flex-middle uk-flex-space-between">
                            <h5 style="width: 100%">Info <a href="" title="" class="add-attr-info pull-right" onclick="return false;">Thêm info +</a></h5>
                        </div>
                        <div class="ibox-content">
                                                ...
                                                <?php if (isset($val['post']) && is_array($val['post']) && count($val['post'])) { ?>
                                                    <?php foreach ($val['post'] as $keyP => $valP) { ?>
                                                        <label class="tpInputLabel" style="width: 100%">
                                                            <input <?php echo((in_array($valP['id'], $temp)) ? 'checked' : ''); ?> name="attr[<?php echo $valP['id'] ?>]" type="checkbox" class="tpInputCheckbox" value="<?php echo $valP['id'] ?>"/>
                    ...
                    <?php /*<div class="ibox mb20">
                        <div class="ibox-title uk-flex uk-flex-middle uk-flex-space-between">
                            <h5 style="width: 100%">HIGHLIGHTS <a href="" title="" class="add-attr-highlight pull-right" onclick="return false;">Thêm highlight +</a></h5>
                        </div>
                        <div class="ibox-content">
                                            ...
                                            if (isset($content_highlight) && is_array($content_highlight) && count($content_highlight)){ ?>
                                                <?php foreach($content_highlight as $key => $val){ ?>
                                                    <div class="form-group desc-more-highlight">
                                                        <div class="col-lg-12">
                                                            <textarea name="content_highlight[]" class="form-control" placeholder="Mô tả"><?php echo $val; ?></textarea>

                                                            <button class="delete-attr-highlight" type="button">X</button>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                            <?php } ?>
