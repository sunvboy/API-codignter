<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			<h2>Thêm mới loại tour</h2>
			<ol class="breadcrumb">
				<li>
					<a href="<?php echo site_url('admin'); ?>">Home</a>
				</li>
				<li class="active"><strong>Thêm mới loại tour</strong></li>
			</ol>
		</div>
	</div>
					...
					<div class="ibox mb20 hidden">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<select name="brand[]" data-json="<?php echo base64_encode($brand) ?>" data-condition="" class="form-control selectMultipe filter" multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm theo tag.." data-module="tour_brand"  style="width:100%"></select>
