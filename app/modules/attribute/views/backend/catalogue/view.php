										...
										<div class="uk-search uk-flex uk-flex-middle mr10">
											<form class="uk-form" id="search">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <?php echo form_dropdown('view', array('0'=>'Chọn hiển thị',1=>'Tour',2=>'Khách sạn',3=>'Car'), set_value('view',$this->input->get('view')) ,'class="form-control select3 input-sm filter view" '); ?>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
							...
							<table class="table table-striped table-bordered table-hover dataTables-example" >
								<thead>
									<tr>
										...
										<?php /*<th style="width:81px;">Tour</th>
										<th style="width:81px;">Khách sạn</th>
										<th style="width:81px;">Car</th>*/?>
