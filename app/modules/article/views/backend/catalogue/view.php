					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-article">
								<li><a type="button" class="ajax-delete-all" data-title="Lưu ý: Khi bạn xóa danh mục bài viết, toàn bộ bài viết trong nhóm này sẽ bị xóa. Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="article_catalogue">Xóa tất cả</a>
								</li>
							</ul>
							<a class="close-link">
							...
							<table class="table table-striped table-bordered table-hover dataTables-example"  >
								<thead>
									<tr>
										...
										<th style="width:100px;">Tin tức trang chủ</th>
										<th style="width:100px;">Có gì đang diễn ra?</th>
									...
									<?php if(isset($listCatalogue) && is_array($listCatalogue) && count($listCatalogue)){ ?>
										...
										?>
											<tr class="gradeX" id="cat-<?php echo $val['id']; ?>">
												...
												<td>
													<a class="maintitle" style="<?php echo ($val['level'] == 1) ? 'font-weight:600;' : ''; ?>" href="<?php echo site_url('article/backend/article/view?catalogueid='.$val['id'].''); ?>" title=""><?php echo str_repeat('|----', (($val['level'] > 0)?($val['level'] - 1):0)).$val['title']; ?> (<?php echo $count; ?>)</a>
												...
												<td>
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" <?php echo ($val['ishome'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="article_catalogue" data-title="ishome" data-id="<?php echo $val['id']; ?>" id="publish_ishome<?php echo $val['id']; ?>">
                                                ...
                                                <td>
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['highlight'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="article_catalogue" data-title="highlight" data-id="<?php echo $val['id']; ?>" id="publish_highlight<?php echo $val['id']; ?>">
