											...
											<tr class="gradeX" id="post-<?php echo $val['id']; ?>">
												...
												<td>
													<div class="uk-flex uk-flex-middle">
														...
														<div class="main-info">
															<div class="title"><a class="maintitle" href="<?php echo site_url('article/backend/article/update/'.$val['id']); ?>" title=""><?php echo $val['title']; ?> (<?php echo $val['viewed']; ?>)</a>
                                                ...
                                                <td class="hidden">
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['ishome'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="article" data-title="ishome" data-id="<?php echo $val['id']; ?>" id="publish_ishome<?php echo $val['id']; ?>">
