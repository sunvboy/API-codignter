							...
							<table class="table table-striped table-bordered table-hover dataTables-example" >
								<thead>
									<tr>
										...
										<th style="width:78px;">Videos giới thiệu</th>
                                                ...
                                                <td>
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['ishome'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="media" data-title="ishome" data-id="<?php echo $val['id']; ?>" id="publish_ishome<?php echo $val['id']; ?>">
