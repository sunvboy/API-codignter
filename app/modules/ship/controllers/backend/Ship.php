...
class Ship extends MY_Controller {
	...
	public function getConditionLocal( $localNot = ''){
//		var_dump($localNot);die;
...
//		$data = $this->getConditionLocal();
		$data['cityCondition'] = $this->Autoload_Model->_get_where(array(
			'table'=>'vn_province',
			'select'=>'provinceid, name',

		),true);
		$data['districtCondition'] = $this->Autoload_Model->_get_where(array(
			'table'=>'vn_district',
