					...
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content profile-content">
							<div class="row">
								...
								<div class="col-lg-12 m-b">
									...
									<div class="ship_city" style="display:<?php echo (!empty($post['city']) || $post['district'] =='') ? 'block' : 'none' ;  ?>">
										<div class="col-lg-12">
											...
											<div class="form-row">
												<?php echo form_dropdown('city[]', '', '', 'class="form-control  selectMultipe" data-module="vn_province" multiple="multiple" data-title="Nhập 2 kí tự để chọn tỉnh, TP.." data-select="name" data-key="provinceid" data-json="'.base64_encode(json_encode($post['city'])).'" style="width: 100%;"  '); ?>
											</div>
										</div>
									...
									<div class="ship_district col-lg-12"  style="display:<?php echo !empty($post['district']) ? 'block' : 'none' ;  ?>">
										<?php $shipAll = $this->input->post('shipAll'); ?>
										<div class="form-row">
											<?php echo form_dropdown('district[]', '', '', 'class="form-control  selectMultipe" data-module="vn_district" multiple="multiple" data-title="Nhập 2 kí tự để chọn quận huyên.." data-select="name" data-key="districtid" data-json='.base64_encode(json_encode($post['district'])).'   style="width: 100%;"  '); ?>
										</div>
									</div>
								...
								<div class="col-lg-12">
									<div class="col-lg-4"><?php echo form_input('value', set_value('value',$this->fcSystem['homepage_ship']), 'class="form-control int" style="width:100%"');?></div>
								</div>
							</div>
