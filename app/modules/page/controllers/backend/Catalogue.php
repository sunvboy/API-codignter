	...
	public function view($page = 1){
		...
		if($config['total_rows'] > 0){
			...
			$data['listCatalogue'] = $this->Autoload_Model->_get_where(array(
				'select' => 'id, title, publish,ishome,highlight,  created, order, level, lft, rgt, (SELECT fullname FROM user WHERE user.id = page_catalogue.userid_created) as user_created',
				'table' => 'page_catalogue',
				'where' => array('alanguage' => $this->fclang),
