										...
										<?php if(isset($listCatalogue) && is_array($listCatalogue) && count($listCatalogue)){ ?>
											...
											<tr>
												...
												<td class="uk-text-center">
													...
													<a type="button" data-title="<?php echo $val['title'];?>" data-name="" data-module="customer_catalogue" data-id="<?php echo $val['id'];?>" class="hidden btn btn-sm btn-trash btn-danger ajax-delete"><i class="fa fa-trash"></i></a>
												</td>
											</tr>
										<?php }} else{?>
												<tr>
