    ...
    public function listproduct()
    {
        ...
        if (isset($listproduct) && is_array($listproduct) && count($listproduct)) {
            foreach ($listproduct as $key => $val) {
                ...
                $html = $html . '<div class="title"><a class="maintitle" href="' . site_url('product/backend/product/update/' . $val['id']) . '" title="">' . $val['title'] . ' (' . $val['viewed'] . ' lượt xem ) ' . (($val['version'] > 0) ? "(có " . $val['version'] . " phiên bản)" : '') . '</a><a href="' . $href . '" title="Lấy địa chỉ liên kết" onclick="prompt(\'Lấy địa chỉ liên kết\',\'' . $href . '\'); return false;"><img border="0" src="template/backend/img/link.png"></a></div>';
                ...
                $html = $html . '<td class="hidden">
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" ' . (($val['ishome'] == 1) ? 'checked=""' : '') . ' class="onoffswitch-checkbox publish_frontend" data-module="product" data-title="ishome" data-id="' . $val['id'] . '" id="publish_frontend-' . $val['id'] . '">
                ...
                $html = $html . '<td class="hidden">
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" ' . (($val['highlight'] == 1) ? 'checked=""' : '') . ' class="onoffswitch-checkbox publish_frontend" data-module="product" data-title="highlight" data-id="' . $val['id'] . '" id="publish_highlight' . $val['id'] . '">
