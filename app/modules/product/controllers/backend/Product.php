        ...
        if($this->input->post('create')){
            ...
            if($this->form_validation->run($this)){
                ...
                $_insert = array(
                    ...
                    'content_tab' => json_encode($content_tab),
                    'content_tab_1' => json_encode($content_tab_1),
                    'content_tab_2' => json_encode($content_tab_2),
