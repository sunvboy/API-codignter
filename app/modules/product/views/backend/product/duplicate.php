							...
							<div class="row mb15">
                                ...
                                <div class="col-lg-12 m-b">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_textarea('content', htmlspecialchars_decode(html_entity_decode(set_value('content', $product['content']))), 'class="form-control ck-editor" id="ckextend_description" placeholder="" autocomplete="off" ');?>
                                    </div>
                                </div>
