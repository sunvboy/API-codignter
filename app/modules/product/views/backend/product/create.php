							...
							<div class="row mb15">
                                ...
                                <div class="col-lg-12 m-b">
                                    <div class="form-row">
                                        ...
                                        <?php echo form_textarea('content', htmlspecialchars_decode(html_entity_decode(set_value('content'))), 'class="form-control ck-editor" id="ckextend_description" placeholder="" autocomplete="off" ');?>
                                    </div>
                                </div>
							...
							<div class="row block-attribute">
								...
								<div class="col-lg-12">
									<div class="uk-flex uk-flex-middle uk-flex-space-between">
										...
										<a data-toggle="modal" class="hidden" data-target="#create_attribute"> Tạo thuộc tính cho SP</a>
									</div>
								</div>
							</div>
						...
						<div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-row">
                                        <?php echo form_input('title_image', set_value('title_image'), 'class="form-control " placeholder="Tiêu đề ảnh" autocomplete="off" ');?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-row">
                                        <?php echo form_textarea('description_image', set_value('description_image'), 'class="form-control " placeholder="Mô tả ảnh" autocomplete="off" ');?>
