					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-product">
								<li><a type="button" class="ajax_delete_product_all" data-title="Lưu ý: Khi bạn thực hiện thao tác này, toàn bộ dữ liệu sẽ không thể khôi phục được. Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="product">Xóa </a>
								</li>
								...
								<div class="ibox" style="border: none !important; margin-bottom: 0px">
					                <div class="ibox-title">
					                	<div class="uk-flex uk-flex-middle uk-flex-space-between">
											...
											<div class="toolbox">
												<div class="uk-flex uk-flex-middle uk-flex-space-between">
													<button type="button" id="update_price_product" class="btn btn-success btn-mb0 m-r hidden">
...
<!--										<th style="width:80px;" class="text-center">FLASH SALE</th>-->
										...
										?>
											<tr class="gradeX" id="post-<?php echo $val['id']; ?>">
												...
												<td>
													<div class="uk-flex uk-flex-middle uk-flex-space-between">
														<div class="uk-flex uk-flex-middle ">
															...
															<div class="main-info">
																<div class="title"><a class="maintitle" href="<?php echo site_url('product/backend/product/update/'.$val['id']); ?>" title=""><?php echo $val['title']; ?> (<?php echo $val['viewed'].' lượt xem'; ?>) <?php echo ($val['version']>0)?"(có ".$val['version']." phiên bản)":'' ?></a>															<a href="<?php echo $href ?>" title="Lấy địa chỉ liên kết" onclick="prompt('Lấy địa chỉ liên kết','<?php echo $href ?>'); return false;"><img border="0" src="template/backend/img/link.png"></a>
																</div>
												...
												<td class="hidden">
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" <?php echo ($val['ishome'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="product" data-title="ishome" data-id="<?php echo $val['id']; ?>" id="publish_frontend-<?php echo $val['id']; ?>">
												...
												<td class="hidden">
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" <?php echo ($val['highlight'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="product" data-title="highlight" data-id="<?php echo $val['id']; ?>" id="publish_frontend_h_<?php echo $val['id']; ?>">
															<label class="onoffswitch-label" for="publish_frontend_h_<?php echo $val['id']; ?>">
																<span class="onoffswitch-inner"></span>
																<span class="onoffswitch-switch"></span>
															</label>
														</div>
												...
												<td class="text-center">
													...
													<a type="button" href="<?php echo site_url('product/backend/product/duplicate/'.$val['id'].'?page=1') ?>" class="btn btn-info hidden"><i class="fa fa-files-o" aria-hidden="true"></i></a>
												</td>
											</tr>
										<?php }}else{ ?>
											<tr>
