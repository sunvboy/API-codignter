...
<!--										<th style="width:81px;">Trang chủ</th>-->
<!--										<th style="width:81px;">Nổi bật</th>-->
<!--										<th style="width:81px;">Aside</th>-->
										...
										?>
											<tr class="gradeX <?php echo ($val['level'] == 1) ? 'bg-gray' : 'hidden' ?>" data-level ="<?php echo $val['level'] ?>" id="cat-<?php echo $val['id']; ?>">
												...
												<?php /*<td>
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" <?php echo ($val['ishome'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="product_catalogue" data-title="ishome" data-id="<?php echo $val['id']; ?>" id="publish_ishome<?php echo $val['id']; ?>">
												...
												<td>
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" <?php echo ($val['highlight'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="product_catalogue" data-title="highlight" data-id="<?php echo $val['id']; ?>" id="publish_highlight<?php echo $val['id']; ?>">
                                                ...
                                                <td>
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['isaside'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="product_catalogue" data-title="isaside" data-id="<?php echo $val['id']; ?>" id="publish_isaside<?php echo $val['id']; ?>">
