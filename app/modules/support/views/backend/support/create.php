						...
						<div class="ibox-content">
							...
							<div class="row" style="margin-bottom:15px;">
								...
								<div class="form-row col-lg-6">
                                    ...
                                    <?php echo form_dropdown('catalogueid', $this->nestedsetbie->dropdown(), set_value('catalogueid') ,'class="form-control input-sm perpage filter catalogueid" style="height:34px !important"'); ?>
